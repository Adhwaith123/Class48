...
function draw() {
  ...
  Coincount = count + Math.round(World.frameRate/60);
  // Moving of the king
...
if(keyWentUp("space")){
 ...
 if( keyDown("space")&& kingattack.isTouching(ObstaclesGroup)){
 ...
 else if(keyDown("space")&&king.x>=250){
...
function spawnObstacles(){
  if(World.frameCount % 120===0){
    Obstacles=createSprite(1500,525,60,60);
